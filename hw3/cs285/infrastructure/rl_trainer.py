...
class RL_Trainer(object):
    def __init__(self, params):
        ...
        if self.params['env_name'] == 'obstacles-cs285-v0':
            import matplotlib
            matplotlib.use('Agg')
    ...
    def collect_training_trajectories(self, itr, initial_expertdata, collect_policy,
                                      num_transitions_to_sample, save_expert_data_to_disk=False):
        """
        :param itr:
        ...
        if itr == 0 and initial_expertdata:
            loaded_paths = pkl.load(open("../../" + initial_expertdata, "rb"))
            return loaded_paths, 0, loaded_paths
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            ob_batch, ac_batch, re_batch, next_ob_batch, terminal_batch = self.agent.sample(batch_size=batch_size)
